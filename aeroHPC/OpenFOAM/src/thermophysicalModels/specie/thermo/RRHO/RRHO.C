...
void Foam::RRHO<EquationOfState>::checkInputData() const
{
    if (Tlow_ >= Thigh_)
    {
...
template<class EquationOfState>
Foam::RRHO<EquationOfState>::RRHO
(
    const word& name,
...
template<class EquationOfState>
void Foam::RRHO<EquationOfState>::write(Ostream& os) const
{
